...
<body>
	...
	<h2>新規資料の追加</h2>
	<hr>
	<p>新しい資料です。資料目録に情報を追加します。</p>
	<form action="/slibsys/AddDocumentServlet" method="post">
	<p>
		資料名：<input type="text" name="bookName" value="" size="" maxlength="">
	</p>
	<p>

		分類コード：<select name="category" class="select" style="width: 150px;">
			<option value="">--</option>
	...
	<p>
		...
		著者：<input type="text" name="author" value="" size="" maxlength="">
	</p>
	<p>
		出版社：<input type="text" name="publisher" value="" size="" maxlength="">
	</p>
	<p>

		出版日：<select name="pyear" class="select">
			<option value="">--</option>
		...
		</select> 年 <SELECT name="pmonth" class="select">
		...
		</SELECT> 月 <SELECT name="pdate" class="select">
			<option value="" selected="selected">--</option>
			<option value="1">1</option>
			<option value="2">2</option>
			<option value="3">3</option>
	...
	<p>
		...
		備考：<input type="text" name="comment" value="" size="" maxlength="">
	</p>
	<p>
