...
<body>
	...
	<hr>
	<p>
		検索したい資料の資料IDを入力してください。<br>何も入力せずに「検索」ボタンを押すと全ての資料の情報が表示されます。
	</p>
	資料ID：
	<form action="/slibsys/SearchDocumentServlet" method="post">
		<input type="text" name="bookStateId" size="" maxlength=""><input
			type="submit" value="検索" class="btn-flat-border"><input type="hidden" name="action"
			value="search">
	</form>
	
	<jsp:include page="/resultSearchDocument.jsp" />
